...
</svg> Supression d'un client &nbsp &nbsp &nbsp &nbsp </h3>  </td>
...
<?php
  ...
  if(isset($_POST['suprimer'])){
    $requete = $db->prepare('DELETE FROM  espace_client  WHERE  id=:n ');
  $requete->execute(array('n' =>$_POST['id']));
    $requete = $db->prepare('DELETE FROM  reservation  WHERE  ID_client=:nn ');
