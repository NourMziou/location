...
<header>
  ...
  <?php
   ...
   try
    ...
    $tab=$db->query('SELECT * FROM facture where payement=\'pas_encore\'');
	
  	echo"<table style=\"width:100%;border: 3px solid #555353;\" border=\"1\" align=\"center\">";
  	echo"<tr><td style=\"border: 3px solid #555353;\" align=\"center\"><strong>ID_facture</strong></td>
    	<td style=\"border: 3px solid #555353;\" align=\"center\"><strong>Nom</strong></td>
  	   ...
  	   while($table=$tab->fetch()){
  		   echo"<tr><td style=\"border: 3px solid #555353;\" align=\"center\">".$table["id"].
		   "</td><td style=\"border: 3px solid #555353;\" align=\"center\">".$table["nom"].
