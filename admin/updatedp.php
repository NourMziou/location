...
<html lang="en">
<head>
  <title>modif date de prise</title>
  <meta charset="utf-8">
...
<header>
  ...
  <div class="container" style="padding-top:100px; align:center;width:75%; ">
   <form class="needs-validation" novalidate action="updatedp.php" method="POST" enctype="application/x-www-form-urlencoded" >
...
</svg> Modification du date de prise &nbsp &nbsp &nbsp &nbsp </h3>  </td>
<td><strong><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-right" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"/>
        ...
        <label for="validationCustom01"style="color:black;" ><strong> Nouvelle date de prise:</strong></label>
...
<?php
  ...
  if(isset($_POST['enregistrer'])){
    $requete = $db->prepare('UPDATE reservation SET Date_de_prise=:n WHERE  id_reservation=:nnn ');
