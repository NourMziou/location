...
<html lang="en">
<head>
  <title>Recherche reservation</title>
  <meta charset="utf-8">
...
</svg> Rechercher une réservation  &nbsp &nbsp &nbsp &nbsp </h3>  </td>
...
try
    ...
    if(isset($_POST['rechercher'])){
      $tab=$db->prepare('SELECT * FROM reservation WHERE id_reservation=:i');
