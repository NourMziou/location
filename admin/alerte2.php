...
<body style="background-color:#BDBDAE;">
 ...
 <div class="container" style="padding-top:100px; align:center;width:70%; ">
   <form class="needs-validation" novalidate action="alerte2.php" method="POST" enctype="application/x-www-form-urlencoded" >
...
</svg> Modification date-assurance: &nbsp &nbsp &nbsp  </h3>  </td>
...
</svg>  Marque du véhicule :&nbsp </strong></td><td><input type="text" name="m" class="form-control" id="validationCustom01"  required  >   <div class="valid-feedback">
    </div></td></tr></table>
      </div>
   <div style="padding-left:30px;">
      <label for="validationCustom01"style="color:black;"><strong> Date de l'assurance:</strong></label>
            <input type="date"  class="form-control" id="validationCustom07"  required name="visite">
...
<?php
  ...
  if(isset($_POST['enregistrer'])){
    $requete = $db->prepare('UPDATE vehicules SET date_assurance=:n WHERE marque=:nn ');
  $requete->execute(array('n' =>$_POST['visite'],
