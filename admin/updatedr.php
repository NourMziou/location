...
<html lang="en">
<head>
  <title>modif date de restitution</title>
  <meta charset="utf-8">
...
<header>
  ...
  <div class="container" style="padding-top:100px; align:center;width:75%; ">
   <form class="needs-validation" novalidate action="updatedr.php" method="POST" enctype="application/x-www-form-urlencoded" >
...
</svg> Modification du date de restitution &nbsp &nbsp &nbsp &nbsp </h3>  </td>
...
</svg>  ID du réservation :&nbsp </strong></td><td><input type="number" name="id" class="form-control" id="validationCustom01"  required  >   <div class="valid-feedback">
    </div></td></tr></table>
      </div>

        <div  style="padding-left:30px;">
        <label for="validationCustom01"style="color:black;" ><strong> Nouvelle date de restitution:</strong></label>
...
<?php
  ...
  if(isset($_POST['enregistrer'])){
    $requete = $db->prepare('UPDATE reservation SET Date_de_restitution=:n WHERE  id_reservation=:nnn ');
